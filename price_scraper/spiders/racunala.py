...
class RacunalaSpider(scrapy.Spider):
    name = "racunala"
    allowed_domains = ["racunala.hr"]
    start_urls = ["https://www.racunala.hr/sitemap.xml"]
    sitemap_urls= ["https://www.racunala.hr/sitemap.xml",]
    ...
    def parse_product(self, response, **kwargs):
        ...
        for script in json_ld:
            ...
            yield PriceScraperItem(
                ...
                sku=product.get("sku"),
                mpn=response.xpath("//div[@class='sifra']/span/text()").get(),
                price=price,
